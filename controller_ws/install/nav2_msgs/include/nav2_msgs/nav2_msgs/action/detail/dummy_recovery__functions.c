  ...
  nav2_msgs__action__DummyRecovery_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_Goal * data =
      (nav2_msgs__action__DummyRecovery_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_Result * data =
      (nav2_msgs__action__DummyRecovery_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_Feedback * data =
      (nav2_msgs__action__DummyRecovery_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_SendGoal_Request * data =
      (nav2_msgs__action__DummyRecovery_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_SendGoal_Response * data =
      (nav2_msgs__action__DummyRecovery_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_GetResult_Request * data =
      (nav2_msgs__action__DummyRecovery_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_GetResult_Response * data =
      (nav2_msgs__action__DummyRecovery_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  nav2_msgs__action__DummyRecovery_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__DummyRecovery_FeedbackMessage * data =
      (nav2_msgs__action__DummyRecovery_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__DummyRecovery_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__DummyRecovery_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
