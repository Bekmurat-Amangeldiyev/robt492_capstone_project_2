...
inline std::string to_yaml(const DummyRecovery_Goal & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const DummyRecovery_Result & msg,
  std::ostream & out)
{
  out << "{";
  // member: total_elapsed_time
...
inline std::string to_yaml(const DummyRecovery_Result & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_Feedback & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const DummyRecovery_Feedback & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_SendGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const DummyRecovery_SendGoal_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_SendGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: accepted
...
inline std::string to_yaml(const DummyRecovery_SendGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_GetResult_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const DummyRecovery_GetResult_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_GetResult_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const DummyRecovery_GetResult_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const DummyRecovery_FeedbackMessage & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const DummyRecovery_FeedbackMessage & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
